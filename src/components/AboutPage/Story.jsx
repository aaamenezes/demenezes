...
export default function Story() {
  return (
    <Container as={StorySection}>
      ...
      <Container>
        <p>Assiti ao painel que falou sobre a carreira dos desenvolvedores, e fiquei encantado com a empolgação dos magníficos <a href="https://twitter.com/brjavaman">Bruno Souza</a> (o Javaman) e da <a href="https://twitter.com/yarasenger">Yara Senger</a>.</p>
      </Container>
      <HighlightText>
