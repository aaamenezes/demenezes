...
export default function Story() {
  return (
    <>
      ...
      <HighlightText>
        Então foi nesse ano que eu caí de verdade no mundo da programação, num
        {' '}
        <a href='https://events.withgoogle.com/google-em-poa/'>evento do Google em Porto Alegre</a>
        . A intenção era apenas registrar as palestras para escrever um post de blog, eu trabalhava com marketing digital na época.
      </HighlightText>
      <Container>
        <p>
          Assiti ao painel que falou sobre a carreira dos desenvolvedores, e fiquei encantado com a empolgação dos magníficos
          {' '}
          <a href='https://twitter.com/brjavaman'>Bruno Souza</a>
          {' '}
          (o Javaman) e
          {' '}
          <a href='https://twitter.com/yarasenger'>Yara Senger</a>
          .
        </p>
      </Container>
      <HighlightText>
